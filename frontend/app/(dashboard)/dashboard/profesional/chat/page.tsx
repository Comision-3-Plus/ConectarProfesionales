/**
 * Página de Chat para Profesionales
 * Permite comunicarse con clientes sobre trabajos
 */
'use client';
...
export default function ProfesionalChatPage() {
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="mb-6">
        ...
        <p className="text-slate-600">
          Comunícate con tus clientes sobre los trabajos
        </p>
      </div>
          ...
          <div className="col-span-2">
            {selectedChatId && selectedChat ? (
              <ChatWindow
                ...
                otherUserName={selectedChat.cliente_nombre || 'Cliente'}
                otherUserAvatar={undefined}
              />
            ) : (
